...
#     Relevant concepts:
#     Instamart services, quick commerce, product delivery,
#     dark stores, grocery delivery, Swiggy Instamart offerings
#     """
...
#     # pages = [doc.metadata["page"] + 1 for doc in docs]
#     # pages = list(set([doc.metadata["page"] + 1 for doc in docs]))
